...
Диагностический запуск CI временно печатает diff gofmt для точного исправления; workflow будет восстановлен до мержа.

Временный отдельный workflow запускает gofmt-diff на GitHub Actions; после диагностики он будет удалён до мержа.
